...
export const traitsInfo : traitsData[] = [
    {
      icon: '🧼',
      title: "Clean Code",
...
export const myData = {
    ...
    bioExtra: "My experience spans multiple areas of the software landscape, helping me stay adaptable in both my technical skills and problem-solving approach.",
    quote: '“Anyone can build a website with AI, but not everyone can create one that truly connects with your audience.”',
